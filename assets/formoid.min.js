var Formoid = (function () {
    ...
    function $ajax(url, settings) {
        return new Promise(function (resolve, reject) {
            ...
            xhr.onload = function () {
                if (xhr.status !== 200) {
                    return reject(new Error('Retorno incorreto do servidor.'));
                }
                resolve(xhr.responseText);
            };
            xhr.onerror = function () {
                var message = 'Falhou ao conectar com o servidor. ';
                if ('onLine' in navigator && !navigator.onLine) {
                    message += 'Sem conexão com a internet.';
                } else {
                    message += 'Verifique a conexão novamente.';
                }
        ...
        return this.getCaptchaToken()
            ...
            .then(function(responseText) {
                ...
                try {
                    ...
                    throw new Error('Retorno incorreto do servidor.');
                }
                if (data.error) {
        ...
        function parseInput(input) {
            return new Promise(function (resolve, reject) {
                ...
                if (input.getAttribute('name') === 'email' && !isValidEmail(input)) {
                    return reject(new Error('Formulário não é válido'));
                }
